# -*- coding: utf-8 -*-
"""
Created on Fri Feb  5 18:08:09 2021
阴阳师自动樱饼:魂11
虚拟鼠标点击，
要求：位置每次与上一次不一样（随机生成）
...
while (True):
    #定义开始
    coord=pyautogui.locateOnScreen('go.png')
    if(coord!=None):
        findAndClick(coord)
    #    print(coord)
    #    print(x)
        ...
        #continue
        coord1=pyautogui.locateOnScreen('continue.png')
        ...
        time.sleep(1)
        coord1=pyautogui.locateOnScreen('damo.png')
        if(coord1!=None):
            findAndClick(coord1)
        print("没找到")